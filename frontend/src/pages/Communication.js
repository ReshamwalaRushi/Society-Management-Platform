...
import { Bell, Plus, Megaphone, Vote } from 'lucide-react';
              ...
              <Card key={a._id} className={`p-5 border-l-4 ${typeColors[a.type] || 'border-blue-400 bg-blue-50'}`}>
                ...
                {a.type === 'poll' && a.pollOptions?.length > 0 && (
                  <div className="mt-3 space-y-2">
                    ...
                    {a.pollOptions.map((opt, i) => {
                      const totalVotes = a.pollOptions.reduce((s, o) => s + o.votes, 0);
          ...
          {form.type === 'poll' && (
            <div className="mb-4">
              ...
              <div className="flex gap-2 mb-2">
                <input value={pollOptionText} onChange={e => setPollOptionText(e.target.value)}
